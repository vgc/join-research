function allCasesMinRadius0(svgGroup, se0, se1, arguments) {
    ...
    if (t0 < 0) {
        ...
        if (!haveSameRadius) {
            ...
            pX = Vec2.ADD(p0, slopeDir.scaled(t0));
        }
        else {
...
var allCasesMinRadius0Method = {
    name: "allCasesMinRadius0",
    prettyname: "allCasesMinRadius0",
    function: allCasesMinRadius0,
    parameters: [
